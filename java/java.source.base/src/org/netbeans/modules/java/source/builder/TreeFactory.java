...
public class TreeFactory {
    ...
    public ReferenceTree Reference(ExpressionTree qualExpr, CharSequence member, List<? extends Tree> paramTypes) {
        ...
        return docMake.at(NOPOS).newReferenceTree(
            "",
            (JCTree.JCExpression) qualExpr, qualExpr == null ? null : ((JCTree.JCExpression) qualExpr).getTree(),
            member != null ? (com.sun.tools.javac.util.Name) names.fromString(member.toString()) : null, 
            paramTypesParam
        );
    }
